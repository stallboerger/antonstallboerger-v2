...
export default function AboutPage() {
  return (
    <section>
      <h1 className="font-bold text-3xl mb-10">UPS App</h1>
      <p className='mb-20'>
      ...
      <Image 
        ...
        priority
      />
      <h2 className='text-base mb-4 font-medium'>Challenges</h2>
      <p className='mb-20'>
      ...
      <Image 
        ...
        priority
      />
      <h2 className='text-base mb-4 font-medium'>Solution</h2>
      <p className='mb-20'>
